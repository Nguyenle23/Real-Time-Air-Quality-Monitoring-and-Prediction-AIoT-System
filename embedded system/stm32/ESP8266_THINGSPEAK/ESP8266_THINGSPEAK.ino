...
char ssid[] = "Khang Ne";    // your network SSID (name)
char pass[] = "tuinecha11";  // your network password
int keyIndex = 0;            // your network key Index number (needed only for WEP)
WiFiClient client;

unsigned long myChannelNumber = 1791091;
const char* myWriteAPIKey = "0J6CAJKJK5BSY8SN";
...
void loop() {
  ...
  if ( (unsigned long) (millis() - time_post) > 22000)
    {
