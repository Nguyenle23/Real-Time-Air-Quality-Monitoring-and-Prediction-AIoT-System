...
const CO2Chart = () => {
  ...
  const realChart = {
    ...
    title: {
      text: `Real-time data of CO2 value on ${formatDate(currentDate)}`,
    },
    subtitle: {
  ...
  const predictChart = {
    ...
    title: {
      text: `Predicted data of CO2 value for next hour on ${formatDate(
        currentDate
      )}`,
    },
    subtitle: {
  ...
  const predictLRFunction = async () => {
    fetchData().then(async (result) => {
      ...
      const dataTemp = await predictCO2WithLR(time);
  ...
  const predictGBFunction = async () => {
    fetchData().then(async (result) => {
      ...
      const dataTemp = await predictCO2WithGB(time);
      const resultPredict = dataTemp.data;
  ...
  const predictRFFunction = async () => {
    fetchData().then(async (result) => {
      ...
      const dataTemp = await predictCO2WithRF(time);
      const resultPredict = dataTemp.data;
  ...
  const predictXGBFunction = async () => {
    fetchData().then(async (result) => {
      ...
      const dataTemp = await predictCO2WithXGB(time);
      const resultPredict = dataTemp.data;
  ...
  const predictKNNFunction = async () => {
    fetchData().then(async (result) => {
      ...
      const dataTemp = await predictCO2WithKNN(time);
      const resultPredict = dataTemp.data;
